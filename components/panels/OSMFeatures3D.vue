...
const props = defineProps({
  ...
  buildingStyleOverride: { type: Object, default: null }
});
...
const rebuildGroup = async (data) => {
  ...
  if (data) {
    ...
    if (props.buildingStyleOverride) {
      opts.regionProfile = {
        styles: props.buildingStyleOverride.styles,
        roofColors: props.buildingStyleOverride.roofColors
      };
    } else {
